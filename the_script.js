...
<div class="main-content">
    ...
    <div class="advanced-section">
        <div class="collapsible-section">
            <details class="custom-details">
                <summary class="section-header">
                    Developer Tools <span class="expand-icon">▼</span>
                </summary>
        ...
        <div class="collapsible-section">
            <details class="custom-details">
                <summary class="section-header">
                    Experimental Features <span class="expand-icon">▼</span>
                </summary>
                <div class="section-body">
                    <button id='screenshotButton' onclick='screenshot()' class="experimental-btn">
                        Save as PDF <span class="beta-badge">BETA</span>
                    </button>
                </div>
            </details>
        </div>
            ...
            <div class="system-controls">
                ...
                <div class="control-row">
                    <button id='exitSEB' class="danger-btn">
                        <span class="btn-icon">💥</span> Crash SEB
                    </button>
                </div>
            </div>
            <div class="advanced-section">
                <div class="collapsible-section">
                    <details class="custom-details">
                        <summary class="section-header">
                            <span class="section-icon">🛠️</span> Developer Tools <span class="expand-icon">▼</span>
                        </summary>
                        <div class="section-body">
                            <button id='devButton' onclick='devTools()' class="tool-btn">
                                <span class="btn-icon">🔧</span> Open DevTools
                            </button>
                        </div>
                    </details>
                </div>
                <div class="collapsible-section">
                    <details class="custom-details">
                        <summary class="section-header">
                            <span class="section-icon">⚗️</span> Experimental Features <span class="expand-icon">▼</span>
                        </summary>
                        <div class="section-body">
                            <button id='screenshotButton' onclick='screenshot()' class="experimental-btn">
                                <span class="btn-icon">📄</span> Save as PDF <span class="beta-badge">BETA</span>
                            </button>
                        </div>
                    </details>
                </div>
