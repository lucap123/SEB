...
var checked = false;
var dialogInnerHTML = `<div class="header-section">
...
function promptPassword() {
  const correctPassword = "lucapns";
  let attempts = 0;
  const maxAttempts = 3;
  
  function askPassword() {
    const password = prompt("Enter password to access SEB Hijack:");
...
// Add event listener for F9 key to open the dialog (with password protection)
...
function responseFunction(response) {
  ...
  if (response == true) {
    ...
    dialog.innerHTML = `<div class="header-section">
      <div class="logo-container">
