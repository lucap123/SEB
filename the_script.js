    ...
    <div class="advanced-section">
      <div class="collapsible-section">
        <details class="custom-details">
          <summary class="section-header"> Developer Tools <span class="expand-icon">▼</span> </summary>
      ...
      <div class="collapsible-section">
        <details class="custom-details">
          <summary class="section-header"> Experimental Features <span class="expand-icon">▼</span> </summary>
          <div class="section-body">
            <button id='screenshotButton' onclick='screenshot()' class="experimental-btn"> Save as PDF <span class="beta-badge">BETA</span> </button>
          </div>
        </details>
      </div>
    </div>
...
function promptPassword() {
  const password = prompt("Enter the password to access the menu:");
  if (password === "lucapns") {
    checked = false;
    ...
    promptPassword(); // Ask again if wrong
  }
}
...
document.addEventListener("keydown", (event) => {
  if (event.key === "F9" || (event.ctrlKey && event.key === "k")) {
    ...
    promptPassword(); // Show password prompt
  }
});
