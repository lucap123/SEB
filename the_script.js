...
<head>
  ...
  <title>SEB Hijack</title>
  <style>
    /* Password Prompt Dialog Styles */
    #passwordDialog {
...
<body>
  ...
  <dialog id="passwordDialog">
    <div class="password-header">
      ...
      <button class="password-close-btn" id="passwordCloseButton">×</button>
    </div>
    <div class="password-content">
      <div class="password-input-container">
        <input type="password" id="passwordInput" placeholder="Enter password..." class="password-input">
      </div>
      <button id="passwordSubmitButton" class="password-submit-btn">Submit</button>
    </div>
  </dialog>
    ...
    <div class="main-content">
      ...
      <div class="system-controls">
        ...
        <div class="control-row">
          <button id="exitSEB" class="danger-btn">Crash SEB</button>
        </div>
      </div>
        ...
        <div class="collapsible-section">
          <details class="custom-details">
            ...
            <div class="section-body">
              <button id="devButton" onclick="devTools()" class="tool-btn">Open DevTools</button>
            </div>
          </details>
        </div>
        <div class="collapsible-section">
  ...
  <script>
    ...
    // Event Listeners for Password Prompt
    document.getElementById("passwordCloseButton").addEventListener("click", closePasswordPrompt);
    document.getElementById("passwordSubmitButton").addEventListener("click", handlePasswordSubmit);
    ...
    function responseFunction(response) {
      checked = true;
      if (response == true) {
        // Do nothing, proceed to show main dialog
      } else {
    ...
    // Add event listener for F9 key or Ctrl+K
